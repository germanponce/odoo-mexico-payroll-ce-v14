odoo.define('hr_payroll_community.WorkEntryPayrollControllerMixin', function (require) {
    'use strict';
    ...
    var WorkEntryPayrollControllerMixin = {
        ...
        */
        ...
        _generatePayslips: function () {
            this.do_action('hr_payroll_community.action_generate_payslips_from_work_entries', {
                additional_context: {
